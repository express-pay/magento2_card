...
namespace Expresspay\Card\Model;
...
class Card extends \Magento\Payment\Model\Method\AbstractMethod
{
    ...
    protected $_gateUrl = "https://api.express-pay.by/v1/web_cardinvoices";
    ...
    )
    {
        ...
        parent::__construct($context,
            ...
            $resourceCollection,
            $data);
        $writer = new \Zend\Log\Writer\Stream(BP . '/var/log/expresspay_card.log');
        $this->_logger = new \Zend\Log\Logger();
        $this->_logger->addWriter($writer);
        $this->_gateUrl = 'https://api.express-pay.by/v1/web_cardinvoices';
    }
    ...
    public function getGateUrl()
    {
        ...
        {
            return "https://sandbox-api.express-pay.by/v1/web_cardinvoices";
        }
        else
        {
    ...
    public function getPostData($orderId)
    {
		...
		$postData = array(
			...
			'FailUrl'           => $storeManager->getStore()->getBaseUrl()."checkout/onepage/failure",
			'Expiration'        => '',
